...
containing one or more custom WPF dialogs. The other is a model to create a WPF 
application, or other assembly, that consumes a custom dialog in a DLL. The 
model application also includes a local custom dialog.
