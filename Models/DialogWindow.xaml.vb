...
'''' <remarks>
'''' <para>
'''' Public members of <see cref="System.Windows.Window"/> are reachable by the
'''' consuming assembly.
'''' </para>
'''' <para>
'''' This class is created as a reusable class available from a DLL. It is not
'''' dedicated to use by any particular application.
'''' </para>
...
''''     .Owner = Me,
''''     .ShowInTaskbar = False,
''''     .Title = "Dialog as a Window in a DLL",
